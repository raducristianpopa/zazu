			...
			<ScrollArea className="h-[310px]">
				<Accordion type="single" collapsible className="w-full">
					{paymentPointers.length === 0 ? (
						<p className="mt-5 text-center font-medium antialiased">
	...
	return (
		<TooltipProvider>
			<Tooltip>
				<TooltipTrigger>
					<Badge variant="ghost">
						<Icons.CheckShield className={`w-4 h-4 ${color}`} />
					</Badge>
				</TooltipTrigger>
...
const AddPaymentPointerForm = () => {
	...
	return (
		<Form {...form}>
			<h1 className="etext-center text-sm uppercase font-medium antialiased mb-5">
				Add payment pointer
			</h1>
			<form
